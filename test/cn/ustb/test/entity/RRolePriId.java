...
/**
 * RRolePriId entity. @author MyEclipse Persistence Tools
 */

public class RRolePriId implements java.io.Serializable {
	...
	/** full constructor */
	public RRolePriId(TRole TRole, TPrivilege TPrivilege) {
		this.TRole = TRole;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RRolePriId))
			return false;
		RRolePriId castOther = (RRolePriId) other;
