...
<body class="rightBody">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td>
            	<s:property value="%{comp.isAnony?'匿名':'非匿名'}"/>
            </td>
        </tr>
        <tr>
            <td class="tdBg">投诉人单位：</td>
            <td>
            	<s:property value="comp.compDept"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <s:property value="comp.compPhone"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
            	<s:property value="comp.compComtent" escape="false"></s:property>
            </td>
        </tr>
        <tr><td colspan="2" align="center">受理信息</td></tr>
        <s:iterator value="comp.replies" status="st">
        <tr>
            <td colspan="2">
