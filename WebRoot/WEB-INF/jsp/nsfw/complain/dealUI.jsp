...
<form id="form" name="form" action="${basePath }nsfw/complain_deal.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:property value="%{complain.isAnony == true? '是':'否'}"/></td>
        </tr>
        <tr>
            <td class="tdBg">投诉人单位：</td>
            <s:if test="!complain.isAnony">
            <td><s:property value="complain.compDept"/></td>
            </s:if>
            <s:else>
            <td>***</td>
            </s:else>
        ...
        <tr>
            ...
            <td><s:property value="complain.compComtent" escape="false"/>
            <!-- ##################################################### -->
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2">
            	<s:iterator value="complain.replies" status="st" var="reply">
            		...
            		回复<s:property value="#st.count"/>&nbsp;</legend><!-- ####################!!!# -->
						...
						回复人：<s:property value="replyName"/><!-- ####################!!!no reply -->
        ...
        <tr>
            ...
            <td><s:textarea id="replyContent" name="reply.replyContent" cols="90" rows="8" /></td>
        </tr>
    </table>
    <s:hidden name="compTitle"></s:hidden>
    <s:hidden name="compState"></s:hidden>
    ...
    <s:hidden name="reply.replyName" value="%{#session.SYS_USER.name}"/>
    
    
    <div class="tc mt20">
        <input type="button" class="btnB2" value="保存" onclick="javascript:checkContent()"/>
        &nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
	function checkContent(contentSize){
