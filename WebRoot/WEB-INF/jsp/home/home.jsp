...
<script type="text/javascript">
	function goDetail(id){
		window.location.href = "${basePath}sys/home_infoViewUI.action?infoId="+id;
	}
</script>
...
<!-- }左 -->
    ...
    <div class="right">
        <div class="left_grzx1">
            ...
            <s:iterator value="infoList">
                <tr>
                    <td height="23">
                    	<a target="_blank" style="text-decoration: none;color: gray" href="javaScript:goDetail('<s:property value="infoId"/>')">
                    		<s:property value="title"/>
                    	</a>
                    </td>
                    <td width="150px">
                    <s:property value="#infoTypeMap[type]"/></td>
                    <td width="150px">
    ...
    <div class="layout_center">
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                <h1>我的投诉</h1>
                <div style="float:right;padding-top:3px;padding-right:8px">
                <%--  ###########################target   <S:A>标签action --%>
            ...
            <table width="98%" border="0" align="center">
            <s:iterator value="compList" var="complain">
            <%--///////////////////////////////////////////////////////////////////////////// --%>
               <s:url var="complainViewURL" action="home_complainViewUI" namespace="/sys">
                ...
                <tr>
                    <td height="23">
						<s:a href="%{#complainViewURL}"><s:property value="compTitle"/></s:a>
                    </td>
                    <td width="180px"><s:property value="#compStateMap[state]"/></td>
                    <td width="180px"><s:property value="%{isAnony?'匿名':'非匿名'}"/></td>
